...
<body>
        ...
        <div class="col-4 text-center">
            <form>
                <div class="input-group mb-3 input-group-sm">
                    ...
                    <input type="number" class="form-control" id="maxCLD" max="100">
                    <div class="input-group-append">
                        <span class="input-group-text"> mm </span>
                    </div>
                </div>
                ...
                <div class="input-group mb-3 input-group-sm">
                    ...
                    <input type="number" class="form-control" id="maxHOP" max="30">
                    <div class="input-group-append">
                        <span class="input-group-text"> mm </span>
                    </div>
                </div>
            ...
            <button class="btn btn-primary btn-sm" type="submit" onclick="calculate();">Calculate</button>
    ...
    <div class="row">
        <div class="col-6 text-center">
            <button class="btn btn-primary btn-sm" type="submit" onclick="download_csv();">Create WorkOrder</button>
        </div>
        <div class="col-5 text-left">
            <button type="button" class="collapsible">HELP</button>
            <div class="content">
                <div> 1. Enter Maximum and Minimum Material Width</div>
                <div> 2. Enter Maximum and Minimum CLD (100mm max) and HOP(30mm max)</div>
                <div> 3. Enter Preferred Installation Height(900-1600mm) for existing Installation</div>
                <div> 4. Click "Calculate" button to get design</div>
                <div> 5. Choose Scanner Orientation</div>
                <div> 6. Choose Communication Protocol</div>
                <div> 7. Choose Optionals</div>
                <div> 8. Click "Create Workorder" button to generate W/O</div>
            </div>
        </div>
    </div>
</body>
