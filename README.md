    ...
    <div class="row">
        ...
        <div class="col-5 text-center">
            <div class="input-group mb-3 input-group-sm">
                ...
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect04">Input</label>
                </div>
                ...
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect04">Output</label>
                </div>
            ...
            <div class="input-group mb-3 input-group-sm">
                ...
                <div class="input-group-prepend">
                    <input type="radio" id="selectedProfiBus" name="selectedProfiBus" value="PB">
                    <label class="input-group-text" for="inputGroupSelect03">ProfiBUS</label>
                    <input type="radio" id="selectedProfiNet" name="selectedProfiNet" value="PN">
                    <label class="input-group-text" for="inputGroupSelect03">ProfiNET</label>
                </div>
...
//        document.getElementById("PreferredHeight").value = document.getElementById("selectedProfiBus").checked
...
//
    ...
    function prepare_lineItems() {
        ...
        // ProfiBus options
        if ((document.getElementById("selProfiBusNet").checked) && (document.getElementById("selectedProfiBus").checked)) {
            LineItem[0] = C775ItemB.length + 1
            LineItem[1] = "B" + C775ItemB.length
            LineItem[2] = '1'
            LineItem[3] = 'EA'
            LineItem[4] = 'PL059823-' + document.getElementById("ProfiPS").value + document.getElementById("selectedProfiBus").value  + document.getElementById("ProfiMC").value;
            LineItem[5] = 'Accuband C775FF ProfiBus Option Assembly'
            LineItem[7] = 'MFG'
            LineItem[12] = '1'
        ...
        // ProfiNET options
        if ((document.getElementById("selProfiBusNet").checked) && (document.getElementById("selectedProfiNet").checked)) {
            LineItem[0] = C775ItemB.length + 1
            LineItem[1] = "B" + C775ItemB.length
            LineItem[2] = '1'
            LineItem[3] = 'EA'
            LineItem[4] = 'PL059823-' + document.getElementById("ProfiPS").value + document.getElementById("selectedProfiNet").value + document.getElementById("ProfiMC").value;
            LineItem[5] = 'Accuband C775FF ProfiNet Option Assembly'
            LineItem[7] = 'MFG'
            LineItem[12] = '1'
